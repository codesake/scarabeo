module Codesake
  module Scarabeo
    # Handles scarabeo version number taken from VERSION file. 
    # The way Haml gem handles its version.rb inspired me for creating this
    # file. 
    class Version

      # Returns a hash representing the version of scarabeo.
      ...
      # If scarabeo is checked out from Git, the `:rev` key will have the revision hash.  
      # 
      # For example:
      #
      #     {
      ...
      #     }
      # 
      # If a prerelease version of scarabeo is being used,
